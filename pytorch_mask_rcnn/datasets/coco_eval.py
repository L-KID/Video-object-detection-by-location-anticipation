...
def prepare_for_coco(predictions):
    ...
    for original_id, prediction in predictions.items():
        ...
        if 'future_boxes' in prediction:
            future_boxes = prediction["future_boxes"]
            boxes = future_boxes
        ...
        x1, y1, x2, y2 = future_boxes.unbind(1)
        future_boxes = torch.stack((x1, y1, x2 - x1, y2 - y1), dim=1)
        future_boxes = future_boxes.tolist()
