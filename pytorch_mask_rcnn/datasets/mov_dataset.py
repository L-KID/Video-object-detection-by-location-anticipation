...
class MOVDataset(GeneralizedDataset):
    ...
    def get_image(self, img_id):
        ...
        image = Image.open(os.path.join('..', img_info["file_name"]))
    ...
    def get_target(self, img_id):
        ...
        target = dict(image_id=torch.tensor([img_id]), boxes=boxes, labels=labels, masks=None)
        return target
